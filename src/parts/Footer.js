                ...
                <div className="row">
                    <div className="col-auto" style={{ width: 350}}>
                        ...
                        <p className="brand-tagline">
                            We kaboom yout beauty holiday instantly and memorable.
                        </p>
                    </div>
                    <div className="col-auto mr-5">
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                <Button type="link" href="/register">New Accounts</Button>
                            </li>
                            <li className="list-group-item">
                    ...
                    <div className="col-2 mr-5">
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">
                                <Button type="link" href="/address">Staycation, Kemang, Jakarta</Button>
                            </li>
                        </ul>
                    </div>
                </div>
